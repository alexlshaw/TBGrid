...
Projectile::Projectile(Transform& startingTransform, float projectileSpeed, glm::vec3 targetLocation, std::string mesh, std::string material)
...
void Projectile::onCollision(GameObject* otherObject)
{
	...
	if (otherLayer & Collision::Layer_Unit)
	{
